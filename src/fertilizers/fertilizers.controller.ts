...
export class FertilizersController {
  ...
  @HttpCode(204)
  async removeBulk(
    @Body(new ZodValidationPipe(deleteFertilizerTypesBulkSchema))
    body: DeleteFertilizerTypesBulkDto,
  ) {
    await this.fertilizersService.removeMany(body.ids);
  }
